 ...
 *                  Employment Type, Status, Photo URL, Login Time/Logout
 *                  Time, Leave Value, Break Start/Break End,
 *                  WorkReports.Submitted At, LeaveRequests, AdvanceRequests,
 ...
 * missing (a blank header, a blank column, a missing sheet) or relabels
 * a header cell in place. Existing data is never touched, duplicated,
 * or overwritten.
 *
...
function setupEMS() {
  ensureSheet_('Users', ['UID', 'Password', 'Name', 'Role', 'Email', 'Designation', 'Department', 'Employment Type', 'Status', 'Photo URL'], [
  ...
  ensureSheet_('WorkReports',
    ['Date', 'Client Name', 'Employee Name', 'Work Type', 'Given', 'Completed', 'Rejected', 'Remark', 'Submitted At'], [
      [new Date('2026-08-01'), 'DeoDap International', 'Aarav Shah', 'Video Creatives', 5, 5, 1, '1 rejected — audio sync issue, re-edited next day', '18:20'],
      [new Date('2026-08-03'), 'Jolly World Tour', 'Aarav Shah', 'Long Form Videos', 2, 2, 0, 'Delivered on time, no revisions', '18:05']
    ]);
  ...
  ensureSheet_('Holidays', ['Date', 'Name', 'Type'], [
    [new Date('2026-01-26'), 'Republic Day', 'National'],
    [new Date('2026-03-04'), 'Holi', 'Festival'],
    [new Date('2026-03-27'), 'Ram Navami', 'Festival'],
    [new Date('2026-04-03'), 'Good Friday', 'Festival'],
    [new Date('2026-05-01'), 'Labour Day', 'National'],
    [new Date('2026-06-17'), 'Eid al-Adha', 'Festival'],
    [new Date('2026-08-15'), 'Independence Day', 'National'],
    [new Date('2026-08-28'), 'Janmashtami', 'Festival'],
    [new Date('2026-09-14'), 'Ganesh Chaturthi', 'Festival'],
    [new Date('2026-10-02'), 'Gandhi Jayanti', 'National'],
    [new Date('2026-11-08'), 'Diwali', 'Festival'],
    [new Date('2026-12-25'), 'Christmas', 'Festival']
  ]);
...
function upgradeEMS() {
  ensureColumns_('Users', ['Designation', 'Department', 'Employment Type', 'Status', 'Photo URL']);
  ensureColumns_('Attendance', ['Login Time', 'Logout Time', 'Leave Value', 'Break Start', 'Break End']);
  ensureColumns_('WorkReports', ['Submitted At']);
